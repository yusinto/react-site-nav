...
})(["grid-column:", " / span 1;display:flex;justify-content:center;align-items:center;&:hover{opacity:0.5;cursor:default;}"], function (_ref6) {
...
})(["grid-column:1 / span ", ";grid-row:2 / span 1;position:relative;height:0;"], function (_ref7) {
...
})(["", ";", ";position:absolute;left:", "px;width:", "px;height:", "px;display:", ";border-radius:4px;box-shadow:0 8px 28px 1px rgba(138,126,138,0.67);animation:", " ", " forwards ease;"], setFromProps('color'), setFromProps('background'), function (_ref8) {
...
var Arrow = _styledComponents.default.div.withConfig({
...
})(["top:-", "px;z-index:1;position:absolute;", " display:", ";width:0;height:0;border-left:", "px solid transparent;border-right:", "px solid transparent;border-bottom:", "px solid ", ";animation:", " ", " forwards ease;"], arrowHeight, function (_ref14) {
  var toData = _ref14.toData,
      leftOffset = _ref14.leftOffset,
      rightOffset = _ref14.rightOffset;
  return calculateArrowMarginLeft(toData, leftOffset, rightOffset);
}, function (_ref15) {
  var display = _ref15.display;
  return display;
}, arrowHeight, arrowHeight, arrowHeight, function (_ref16) {
  var background = _ref16.background;
  return background;
}, function (_ref17) {
  var fadeOut = _ref17.fadeOut,
      display = _ref17.display,
      fromData = _ref17.fromData,
      toData = _ref17.toData,
  ...
  var fadeOut = _ref18.fadeOut,
      display = _ref18.display,
      fromData = _ref18.fromData,
...
})(["position:absolute;margin-top:0;margin-bottom:0;width:100%;height:100%;opacity:", ";z-index:", ";animation:", "  ", "s forwards;"], function (_ref19) {
  var show = _ref19.show;
  return show ? 1 : 0;
}, function (_ref20) {
  var show = _ref20.show;
  return show ? 1 : 0;
}, function (_ref21) {
  var show = _ref21.show,
      fadeOut = _ref21.fadeOut;
...
var ContentGroup = function ContentGroup(_ref23) {
...
function (_Component) {
  ...
  _createClass(SiteNav, [{
    ...
    value: function render() {
      ...
      var rootGridItems = this.memoizeGridItems(children);
